...
function Page() {
  ...
  return (
    <main className="auth-page w-full h-full flex justify-center items-center bg-ttbgsec">
      <form className="m-[2rem] px-10 py-14 rounded-lg bg-ttbgsec max-w-[520px] w-full">
        <div className="relative z-10">
          ...
          {/* Повторите пароль */}
          <div className="relative mt-[1rem] flex flex-col">
            <label htmlFor="confirmPassword" className="mb-1 text-tttextsec">
              Повторите пароль
            </label>
            <input
              type={showPassword ? "text" : "password"}
